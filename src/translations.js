const translations = {
  en: {
    ...
    enterStartWorkTime: 'Enter Start Work Time',
    enterEndWorkTime: 'Enter End Work Time',
    startTimeRecorded: 'Start time recorded successfully!',
    endTimeRecorded: 'End time recorded successfully!',
  },
  ru: {
    ...
    currentExpenditure: 'Текущие расходы',
    ...
    enterStartWorkTime: 'Введите время начала работы',
    enterEndWorkTime: 'Введите время окончания работы',
    startTimeRecorded: 'Время начала успешно зафиксировано!',
    endTimeRecorded: 'Время окончания успешно зафиксировано!',
  },
  he: {
    ...
    currentExpenditure: 'הוצאה נוכחית',
    ...
    enterStartWorkTime: 'הזן את שעת התחלת העבודה',
    enterEndWorkTime: 'הזן את שעת סיום העבודה',
    startTimeRecorded: 'שעת התחלה נרשמה בהצלחה!',
    endTimeRecorded: 'שעת סיום נרשמה בהצלחה!',
  },
};
